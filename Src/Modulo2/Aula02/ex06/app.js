...
const existsPinnacle = fruits.includes('abacaxi')
const existsPear = fruits.includes('pera')
...
//     booleanAmount = booleanAmount + 1  ou += 1
//   }
//   else {
...
//     evenNumbers.push(randomNumbers[1])
//   } else {
//     oddNumbers.push(randomNumbers[1])
//   }
// }
